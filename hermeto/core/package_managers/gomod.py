...
from hermeto.core.models.sbom import Annotation, Component, timestamp_now
...
def fetch_gomod_source(request: Request) -> RequestOutput:
    ...
    annotations = []
    # If we reached this spot in the permissive mode, we can be sure
    # that the vendor directory was changed after vendoring.
