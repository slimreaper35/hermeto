...
class TestCreateBackendAnnotation:
    def test_annotation_with_deduplicated_subjects(self) -> None:
        ...
        annotation = create_backend_annotation(components, "npm")
        assert annotation is not None
        assert annotation.text == f"{APP_NAME}:backend:npm"
    ...
    def test_empty_components_returns_none(self) -> None:
        assert create_backend_annotation([], "pip") is None
